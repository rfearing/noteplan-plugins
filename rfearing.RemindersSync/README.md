# Apple Reminders Noteplan Plugin

## Latest Updates

See [CHANGELOG](https://github.com/NotePlan/plugins/blob/main/rfearing.RemindersSync/CHANGELOG.md) for latest updates/changes to this plugin.

## About This Plugin 

List and update apple reminders
